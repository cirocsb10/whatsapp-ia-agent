            ...
            <>
              ...
              <div className="inbox-chat-header">
                ...
                <div className="flex items-center gap-1" style={{ color: "var(--wa-icon)" }}>
                  {activeConv.isAssumed ? (
                    <button
                      className="inbox-topbar-btn flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[12px] font-medium"
              ...
              {activeConv.isAssumed ? (
                <div className="inbox-input-bar" style={{ gap: "8px", alignItems: "flex-end" }}>
                  ...
                  />
                  <button
                    className="inbox-input-mic"
                    title="Enviar mensagem"
                    onClick={() => void handleSend()}
                    style={{ background: draft.trim() ? "#00a884" : undefined }}
                  >
