      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="inbox-sidebar">
          ...
          <div className="inbox-topbar">
            <div
              className="inbox-topbar-avatar text-sm font-bold"
        ...
        <main className="flex-1 flex flex-col overflow-hidden" style={{ background: "var(--wa-chat)" }}>
          {activeId && activeConv ? (
              ...
              <div className="inbox-input-bar">
                <div className="inbox-input-inner">
                  {activeConv.isHandoff ? (
                    ...
                    <div className="flex items-center gap-2 px-4 py-2.5 w-full">
                      <Bot className="w-4 h-4 flex-shrink-0" style={{ color: "var(--wa-green)" }} />
                      <span className="text-[13px]" style={{ color: "var(--wa-muted)" }}>
            ...
            <div className="flex-1 flex items-center justify-center" style={{ background: "var(--wa-chat)" }}>
